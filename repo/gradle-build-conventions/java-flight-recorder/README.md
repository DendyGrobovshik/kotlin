...
It's mainly used in `test-inputs-check-v2`, but since JFR is also a profiler, it may be useful without the undeclared inputs check. Because of that, it's implemented as a separate convention.
