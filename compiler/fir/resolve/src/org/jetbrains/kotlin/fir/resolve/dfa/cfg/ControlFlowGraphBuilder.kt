...
class ControlFlowGraphBuilder private constructor(
    ...
    fun exitDelegateExpression(fir: FirExpression): Pair<DelegateExpressionExitNode, List<CFGNode<*>>> {
        ...
        return exitNode to lambdaExitNodes
    }
    ...
    fun exitEqualityOperatorCall(
    ...
    ): Triple<CFGNode<*>, EqualityOperatorCallNode, List<CFGNode<*>>> {
        ...
        return Triple(lhsExitNode, node, lambdaExitNodes)
    }
    ...
    fun exitWhenExpression(
        ...
        callCompleted: Boolean,
    ): Triple<WhenExitNode, WhenSyntheticElseBranchNode?, List<CFGNode<*>>> {
        ...
        return Triple(whenExitNode, syntheticElseBranchNode, lambdaExitNodes)
    }
    ...
    fun exitTryExpression(callCompleted: Boolean): Pair<TryExpressionExitNode, List<CFGNode<*>>> {
        ...
        node.updateDeadStatus()
        lastNodes.push(node)
        return node to lambdaExitNodes
    }
    ...
    fun exitFunctionCall(functionCall: FirCall, callCompleted: Boolean): Pair<FunctionCallExitNode, List<CFGNode<*>>> {
    ...
    fun exitDelegatedConstructorCall(
        ...
        callCompleted: Boolean,
    ): Pair<DelegatedConstructorCallNode, List<CFGNode<*>>> {
    ...
    fun exitStringConcatenationCall(call: FirStringConcatenationCall): Pair<StringConcatenationCallNode, List<CFGNode<*>>> {
    ...
    fun exitCheckNotNullCall(
        ...
        callCompleted: Boolean,
    ): Pair<CheckNotNullCallNode, List<CFGNode<*>>> {
    ...
    fun exitSafeCall(): Pair<ExitSafeCallNode, List<CFGNode<*>>> {
    ...
    fun exitElvis(lhsIsNotNull: Boolean, callCompleted: Boolean): Pair<ElvisExitNode, List<CFGNode<*>>> {
