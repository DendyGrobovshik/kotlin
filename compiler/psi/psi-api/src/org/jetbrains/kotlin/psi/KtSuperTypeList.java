...
public class KtSuperTypeList extends KtElementImplStub<KotlinPlaceHolderStub<KtSuperTypeList>> {
    ...
    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().addSuperTypeListEntry(this, entry)} instead.
     */
    @NotNull
    @Deprecated
    public KtSuperTypeListEntry addEntry(@NotNull KtSuperTypeListEntry entry) {
        return KtPsiMutationService.getInstance().addSuperTypeListEntry(this, entry);
    }

    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().removeSuperTypeListEntry(this, entry)} instead.
     */
    @Deprecated
    public void removeEntry(@NotNull KtSuperTypeListEntry entry) {
        KtPsiMutationService.getInstance().removeSuperTypeListEntry(this, entry);
    }
