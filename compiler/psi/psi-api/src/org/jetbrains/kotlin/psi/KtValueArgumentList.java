...
public class KtValueArgumentList extends KtElementImplStub<KotlinPlaceHolderStub<KtValueArgumentList>> {
    ...
    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().addValueArgument(this, argument)} instead.
     */
    @NotNull
    @Deprecated
    public KtValueArgument addArgument(@NotNull KtValueArgument argument) {
        return KtPsiMutationService.getInstance().addValueArgument(this, argument);
    }

    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().addValueArgumentAfter(this, argument, anchor)} instead.
     */
    @NotNull
    @Deprecated
    public KtValueArgument addArgumentAfter(@NotNull KtValueArgument argument, @Nullable KtValueArgument anchor) {
        return KtPsiMutationService.getInstance().addValueArgumentAfter(this, argument, anchor);
    }

    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().addValueArgumentBefore(this, argument, anchor)} instead.
     */
    @NotNull
    @Deprecated
    public KtValueArgument addArgumentBefore(@NotNull KtValueArgument argument, @Nullable KtValueArgument anchor) {
        return KtPsiMutationService.getInstance().addValueArgumentBefore(this, argument, anchor);
    }

    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().removeValueArgument(this, argument)} instead.
     */
    @Deprecated
    public void removeArgument(@NotNull KtValueArgument argument) {
        KtPsiMutationService.getInstance().removeValueArgument(this, argument);
    }

    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().removeValueArgument(this, index)} instead.
     */
    @Deprecated
    public void removeArgument(int index) {
        KtPsiMutationService.getInstance().removeValueArgument(this, index);
    }
