...
public class KtPackageDirective extends KtModifierListOwnerStub<KotlinPlaceHolderStub<KtPackageDirective>> {
    ...
    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().setPackageDirectiveFqName(this, fqName)} instead.
     */
    @Deprecated
    public void setFqName(@NotNull FqName fqName) {
        KtPsiMutationService.getInstance().setPackageDirectiveFqName(this, fqName);
    }
