...
public class KtProperty extends KtTypeParameterListOwnerStub<KotlinPropertyStub>
    ...
    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().setPropertyTypeReference(this, typeRef)} instead.
     */
    @Override
    @Nullable
    @Deprecated
    ...
    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().setPropertyInitializer(this, initializer)} instead.
     */
    @Nullable
    @Deprecated
