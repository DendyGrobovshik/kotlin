...
public class KtParameterList extends KtElementImplStub<KotlinPlaceHolderStub<KtParameterList>> {
    ...
    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().addParameter(this, parameter)} instead.
     */
    @NotNull
    @Deprecated
    public KtParameter addParameter(@NotNull KtParameter parameter) {
        return KtPsiMutationService.getInstance().addParameter(this, parameter);
    }

    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().addParameterBefore(this, parameter, anchor)} instead.
     */
    @NotNull
    @Deprecated
    public KtParameter addParameterBefore(@NotNull KtParameter parameter, @Nullable KtParameter anchor) {
        return KtPsiMutationService.getInstance().addParameterBefore(this, parameter, anchor);
    }

    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().addParameterAfter(this, parameter, anchor)} instead.
     */
    @NotNull
    @Deprecated
    public KtParameter addParameterAfter(@NotNull KtParameter parameter, @Nullable KtParameter anchor) {
        return KtPsiMutationService.getInstance().addParameterAfter(this, parameter, anchor);
    }

    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().removeParameter(this, parameter)} instead.
     */
    @Deprecated
    public void removeParameter(@NotNull KtParameter parameter) {
        KtPsiMutationService.getInstance().removeParameter(this, parameter);
    }

    /**
     * @deprecated Use {@code KtPsiMutationService.getInstance().removeParameter(this, index)} instead.
     */
    @Deprecated
    public void removeParameter(int index) {
        KtPsiMutationService.getInstance().removeParameter(this, index);
    }
