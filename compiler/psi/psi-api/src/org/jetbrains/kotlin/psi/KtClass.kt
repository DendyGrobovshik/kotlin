...
@Deprecated(
    "Use KtPsiMutationService.getInstance().getOrCreatePrimaryConstructor(this) instead",
    ReplaceWith("KtPsiMutationService.getInstance().getOrCreatePrimaryConstructor(this)"),
)
...
@Deprecated(
    "Use KtPsiMutationService.getInstance().getOrCreatePrimaryConstructorParameterList(this) instead",
    ReplaceWith("KtPsiMutationService.getInstance().getOrCreatePrimaryConstructorParameterList(this)"),
)
@OptIn(KtNonPublicApi::class)
