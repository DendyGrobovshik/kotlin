...
class KtSecondaryConstructor : KtConstructor<KtSecondaryConstructor> {
    ...
    @Deprecated(
        "Use KtPsiMutationService.getInstance().replaceImplicitDelegationCallWithExplicit(this, isThis) instead",
        ReplaceWith("KtPsiMutationService.getInstance().replaceImplicitDelegationCallWithExplicit(this, isThis)"),
    )
    fun replaceImplicitDelegationCallWithExplicit(isThis: Boolean): KtConstructorDelegationCall =
        KtPsiMutationService.getInstance().replaceImplicitDelegationCallWithExplicit(this, isThis)
}
