...
open class KtCommonFile(viewProvider: FileViewProvider, val isCompiled: Boolean) :
    ...
    var packageFqName: FqName
        ...
        @Deprecated("Use KtPsiMutationService.getInstance().setCommonFilePackageFqName(this, value) instead")
        @OptIn(KtNonPublicApi::class)
        set(value) {
            KtPsiMutationService.getInstance().setCommonFilePackageFqName(this, value)
        }
