...
@Deprecated(
    "Use KtPsiMutationService.getInstance().replaceFileAnnotationList(file, annotationList) instead",
    ReplaceWith("KtPsiMutationService.getInstance().replaceFileAnnotationList(file, annotationList)"),
)
