...
open class KtNamedFunction : KtTypeParameterListOwnerStub<KotlinFunctionStub>, KtFunction, KtDeclarationWithInitializer {
    ...
    @Deprecated(
        "Use KtPsiMutationService.getInstance().setFunctionTypeReference(this, typeRef) instead",
        ReplaceWith("KtPsiMutationService.getInstance().setFunctionTypeReference(this, typeRef)"),
    )
