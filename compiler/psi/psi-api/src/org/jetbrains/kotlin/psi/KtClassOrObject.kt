...
abstract class KtClassOrObject :
    ...
    @Deprecated(
        "Use KtPsiMutationService.getInstance().addSuperTypeListEntry(this, superTypeListEntry) instead",
        ReplaceWith("KtPsiMutationService.getInstance().addSuperTypeListEntry(this, superTypeListEntry)"),
    )
    fun addSuperTypeListEntry(superTypeListEntry: KtSuperTypeListEntry): KtSuperTypeListEntry =
        KtPsiMutationService.getInstance().addSuperTypeListEntry(this, superTypeListEntry)

    @Deprecated(
        "Use KtPsiMutationService.getInstance().removeSuperTypeListEntry(this, superTypeListEntry) instead",
        ReplaceWith("KtPsiMutationService.getInstance().removeSuperTypeListEntry(this, superTypeListEntry)"),
    )
    fun removeSuperTypeListEntry(superTypeListEntry: KtSuperTypeListEntry) {
        KtPsiMutationService.getInstance().removeSuperTypeListEntry(this, superTypeListEntry)
    }
    ...
    @Deprecated(
        "Use KtPsiMutationService.getInstance().addDeclaration(this, declaration) instead",
        ReplaceWith("KtPsiMutationService.getInstance().addDeclaration(this, declaration)"),
    )
    inline fun <reified T : KtDeclaration> addDeclaration(declaration: T): T =
        KtPsiMutationService.getInstance().addDeclaration(this, declaration)

    @Deprecated(
        "Use KtPsiMutationService.getInstance().addDeclarationAfter(this, declaration, anchor) instead",
        ReplaceWith("KtPsiMutationService.getInstance().addDeclarationAfter(this, declaration, anchor)"),
    )
    inline fun <reified T : KtDeclaration> addDeclarationAfter(declaration: T, anchor: PsiElement?): T =
        KtPsiMutationService.getInstance().addDeclarationAfter(this, declaration, anchor)

    @Deprecated(
        "Use KtPsiMutationService.getInstance().addDeclarationBefore(this, declaration, anchor) instead",
        ReplaceWith("KtPsiMutationService.getInstance().addDeclarationBefore(this, declaration, anchor)"),
    )
    inline fun <reified T : KtDeclaration> addDeclarationBefore(declaration: T, anchor: PsiElement?): T =
        KtPsiMutationService.getInstance().addDeclarationBefore(this, declaration, anchor)
...
@Deprecated(
    "Use KtPsiMutationService.getInstance().getOrCreateBody(this) instead",
    ReplaceWith("KtPsiMutationService.getInstance().getOrCreateBody(this)"),
)
fun KtClassOrObject.getOrCreateBody(): KtClassBody = KtPsiMutationService.getInstance().getOrCreateBody(this)
