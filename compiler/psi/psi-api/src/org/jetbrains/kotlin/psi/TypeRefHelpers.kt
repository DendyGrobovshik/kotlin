...
@Deprecated(
    "Use KtPsiMutationService.getInstance().setCallableTypeReference(declaration, addAfter, typeRef) instead",
    ReplaceWith("KtPsiMutationService.getInstance().setCallableTypeReference(declaration, addAfter, typeRef)"),
)
...
@Deprecated(
    "Use KtPsiMutationService.getInstance().setCallableReceiverTypeReference(this, typeRef) instead",
    ReplaceWith("KtPsiMutationService.getInstance().setCallableReceiverTypeReference(this, typeRef)"),
)
...
@Deprecated(
    "Use KtPsiMutationService.getInstance().setFunctionTypeReceiverTypeReference(this, typeRef) instead",
    ReplaceWith("KtPsiMutationService.getInstance().setFunctionTypeReceiverTypeReference(this, typeRef)"),
)
